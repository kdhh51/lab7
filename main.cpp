...
//1. printStudentName 함수 정의: 리턴은 없고, 매개변수는 studentsName형 1개 매개변수에 따라 kim은 KIM, 을 출력 
//lee는 LEE, 를 출력 
//park은 PARK, 를 출력
//kim, lee, park이 아니면 NO NAME, 을 출력

void printStudentName(studentsName name)
{
    switch(name)
    {
        case kim: 
...
//두번째 student를 선언하고 이를 printStudent에 인자로 넣어 호출합니다. 
//이때 출력되는 값은 무엇인가요?
